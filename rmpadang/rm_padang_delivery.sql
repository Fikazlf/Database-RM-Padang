...
CREATE TABLE `delivery` (
  `id_delivery` varchar(6) NOT NULL,
  ...
  `status_delivery` enum('OTW','DELIVERED') DEFAULT NULL,
  PRIMARY KEY (`id_delivery`),
  KEY `id_transaksi_idx` (`id_transaksi`),
...
INSERT INTO `delivery` VALUES ('DLV001','TRS007','PSN007','Nayla','Bekasi Utara','0812391283','Nopal','DELIVERED');
